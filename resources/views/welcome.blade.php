...
<head>
  ...
  <title>ClearView Tree Services | Professional Tree Care</title>
  <meta name="description" content="ClearView Tree Services — licensed, insured, ISA-certified arborists offering tree removal, trimming, stump grinding, and emergency tree care." />
  ...
  <nav class="navbar" id="navbar">
    <div class="container nav-inner">
      <a href="#home" class="nav-brand">
        ...
        <span class="brand-name">ClearView <em>Tree Services</em></span>
      </a>
    ...
    <div class="hero-inner">
      <div class="hero-content">
        ...
        <div class="hero-stats">
          <div class="stat"><span class="stat-num">500+</span><span class="stat-label">Jobs Completed</span></div>
          <div class="stat-divider"></div>
          <div class="stat"><span class="stat-num">18+</span><span class="stat-label">Years Experience</span></div>
          <div class="stat-divider"></div>
      ...
      <div class="hero-visual">
        <div class="hero-img-wrap" id="hero-img-wrap">
          <img src="{{ asset('images/boom1.jpg') }}" alt="ClearView Tree Services crew at work"
        ...
        <div class="hero-rating">
          ...
          <div class="rating-text"><strong>4.9 / 5.0</strong><span>200+ verified reviews</span></div>
        </div>
      ...
      <div class="about-grid">
        <div class="about-visual fade-up">
          <div class="about-img-main">
            <img src="{{ asset('images/boom2.jpg') }}" alt="ClearView Tree Services professional"
              onerror="this.parentElement.style.background='linear-gradient(135deg,#2d6a4f,#1b4332)'; this.style.display='none';" />
          </div>
          <div class="about-img-secondary">
            <img src="{{ asset('images/boom1.jpg') }}" alt="ClearView Tree Services job site"
        ...
        <div class="about-content fade-up" data-delay="2">
          ...
          <p>ClearView Tree Services has been serving homeowners and businesses for over 18 years. Our ISA-certified arborists bring expertise, professionalism, and a genuine passion for trees to every job — big or small.</p>
  ...
  <section class="why-us" id="why-us">
    <div class="container">
      <div class="section-header light fade-up">
        ...
        <p>What sets us apart from every other tree company in the area.</p>
      </div>
        ...
        <div class="contact-info fade-up">
          ...
          <div class="contact-details">
            <div class="contact-item">
              ...
              <div><strong>Call or Text</strong><span>(555) 234-5678</span></div>
            </div>
            <div class="contact-item">
  ...
  <footer class="footer">
    ...
    <div class="footer-bottom">
      <div class="container footer-bottom-inner">
        <p>&copy; {{ date('Y') }} ClearView Tree Services. All rights reserved.</p>
